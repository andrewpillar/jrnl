...
Atom and RSS feeds can be generated by passing the `-a`, and `-r` flags to the `jrnl publish` command respectively. Each of these flags will take a path to the file where you would like the feed to be written to.
