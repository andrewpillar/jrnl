...
// Render the given layout to the given io.Writer. The given name is just used for debugging
// purposes, and more often than not will be the name of the layout file being used.
